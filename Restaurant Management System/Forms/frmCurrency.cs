...
namespace Cindy_Restaurant.Forms
{
    public partial class frmCurrency : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (clsInsert.err.GetError(txtCurSymbol).Length != 2)
            {
        ...
        void _CheckCurrencyExist()
        {
            try
            {
                ...
                if (count == 1)
                {
                    MessageBox.Show("Currency Already Exist", "Save Data - RESTURENT MANAGEMENT SYSTEM", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
                else
                {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error: " + ex.Message, "Throwing Exception - RESTURENT MANAGEMENT SYSTEM", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            if (txtCurSymbol.Text.Trim().Length >= 5)
            {
